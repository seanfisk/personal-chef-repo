...
# 'node_name' should correspond to the Opscode hosted chef username. That's
# because 'node_name' actually specifies the client name, and we want to log in
# with our 'user' client, not our 'machine' client.
node_name 'seanfisk'
